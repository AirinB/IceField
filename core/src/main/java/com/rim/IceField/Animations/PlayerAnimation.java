...
public class PlayerAnimation {
    ...
    private void initializeAnimation() {
        if (player.getTag().equals("Eskimo")) {
            ...
            walkSheet = new Texture(Gdx.files.internal("assets/explorer_1x.png"));

        }else if(player.getTag().equals("PolarExplorer")) {
            // Load the sprite sheet as a Texture

            walkSheet = new Texture(Gdx.files.internal("assets/eskimo_1xd.png"));
    ...
    public void render() {
        ...
        if (isMoving) {
            ...
            currentFrame = walkAnimations.get(player.getDirection()).getKeyFrame(2, true);
        }
